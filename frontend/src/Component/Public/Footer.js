      ...
      <Grid container spacing={2} justifyContent="space-between">
        ...
        <Box>
          <Grid item xs={12} sm={6} md={4}>
            ...
            <Typography variant="body2" color="#f0f0f0" sx={{ mt: 1 }}>
        ...
        <Grid item xs={12} sm={6} md={4}>
          <Grid container spacing={2}>
            <Box mr={15}>
              <Grid item xs={6}>
                <Typography variant="h6" color="white">Our Divisions</Typography>
                {[
                  "Infrastructure",
                  "Mining & Metals",
                  "Power & Energy",
            ...
            <Grid item xs={6}>
              <Typography variant="h6" color="white">Our Links</Typography>
        ...
        {/* Subscribe Section */}
        <Grid item xs={12} sm={6} md={4}>
          <Typography variant="h6" color="white">Subscribe</Typography>
          <Box sx={{ display: "flex", mt: 1,  backgroundColor:'whitesmoke'}}>
            <TextField
              variant="outlined"
              size="small"
            ...
            >
              <MailOutlineIcon sx={{ color: "#000000" }} />
            </Button>
          </Box>
          <Typography variant="body2" color="#f0f0f0" sx={{ mt: 1 }}>
          ...
          <Divider
            sx={{ fontWeight: "bold", borderColor: "white", mt: "15px" }}
          ></Divider>
