import { Box, Typography, Card, CardContent, Grid, List, ListItem, Stack, Breadcrumbs } from "@mui/material";
...
const Rpo = () => {
  ...
  <Grid item xs={12} md={8} sx={{ position: "relative", textAlign: "center" }}>
    {/* Responsive Image */}
    <Box
      component="img"
      src={rpoBg}
  ...
  <Typography variant="body2" sx={{ lineHeight: 1.8 }}>
    Recruitment Process Outsourcing (RPO) an IT Enables Service (ITES) is a form of business process outsourcing (BPO) 
    where an employer transfers all or part of its recruitment processes to Spirale HR Solutions Pvt. Ltd. (Formerly Spirale India Solutions).
    We extend RPO services for permanent as well as contractual staffing. We manage the entire recruiting/hiring process from job profiling 
    through the onboarding of the new hire, including staff, technology, method, and reporting. We may, if need be, adopt the client company's 
    technology, methodologies, and reporting.
    <br /><br />
    Spirale HR Solutions Pvt. Ltd. (Formerly Spirale India Solutions) RPO solution differs greatly from all our other 
    recruitment services in that RPO assumes ownership of the design, management, and control of the recruitment process and the responsibility of results.
    We offer a range of RPO services for permanent as well as contractual staffing. RPO makes the talent acquisition process simpler, more efficient, and cost-effective.
    For our clients, which may be international placement agencies or direct employers, we are geared to provide 24x7 RPO services.
    <br /><br />
    We assume ownership for the entire design, execution, and control of the recruitment process and the responsibility of results. 
    We may, if need be, adopt the client company's process, technology, methodologies, and reporting. Our recruiters are equipped with access to all major 
    proprietary and external resume databases, job portals, social media networks, and powerful e-recruitment methods and technology to identify both active and passive job seekers.
    <br /><br /> 
    We can also use your subscriptions to job portals to source candidates for your requirements.
  </Typography>
         </Grid>
      </Grid>
      ...
      <Box sx={{ mt: 2 }}>
        <Typography variant="h5" fontWeight="bold">
          Recruitment processes that staffing companies or 
          employers may outsource to SHSPL include
        </Typography>
        <List sx={{ mt: 1 }}>
          {[
...
{/* Job Posting Section */}
      ...
      <Box sx={{ mt: 2 }}>
        ...
        <Stack direction={{ xs: "column", sm: "row" }} spacing={4} alignItems="center">
          <Box sx={{ flex: 1, textAlign: "center" }}>
            <img src={R1} alt="HR Solutions" style={{ maxWidth: "100%", height: "auto", borderRadius: "8px" }} />
          </Box>
          <Box sx={{ flex: 2 }}>
            <List>
              {[
  ...
  <Grid container spacing={4}>
    ...
    <Grid item xs={12} md={6}>
      ...
      fontWeight="bold">How does it work?</Typography>
      <List sx={{ mt: 2 }}>
        {[
    ...
    {/* Your Benefits */}
    <Grid item xs={12} md={6}>
      <Typography variant="h4" fontWeight="bold">Your Benefits</Typography>
      <List sx={{ mt: 2 }}>
        {[
        ...
        <List sx={{ mt: 2 }}>
          <ListItem sx={{ display: 'list-item', listStyleType: 'disc', pl: 2, ml: 2 }}>
            <Typography variant="body2">
              Posting jobs on career sites and Job Portals is today an indispensable and therefore a widely used means of sourcing resumes. However, posting these
              advertisements, managing responses, shortlisting resumes, and integrating them with client's proprietary resume Management systems requires a colossal amount
              of time, resources, and energy. The Search House simplifies this process. Our dedicated team of Recruitment Process Executives work on your manpower
              requirements to ensure that all vacancies are timely advertised, responses monitored, all resumes received are dealt with as per your selection criteria, and prompt
              communications are sent out. All you do is E-mail and share your candidate requirements we take care of the rest. We can process and manage a huge amount of
              resumes received by e-mail and post etc. and convert this data into the electronic format and transmit the data for uploading onto a searchable Recruitment
              management system.
            </Typography>
          </ListItem>
        </List>
      ...
      <Box sx={{ mt: 5 }}>
        ...
        <Stack direction={{ xs: "column", sm: "row" }} spacing={4} >
          <Box sx={{ flex: 1, textAlign: "center" }}>
            <img src={R2} alt="Head Hunt Research" style={{ maxWidth: "100%", height: "auto", borderRadius: "8px" }} />
          </Box>
          <Box sx={{ flex: 2 }}>
            <List>
              {[
