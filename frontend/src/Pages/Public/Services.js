...
import {
    Box, Button, Card, CardActions, CardContent, CardMedia, Divider, Grid, Typography, useTheme
} from '@mui/material';
import bg1 from '../../assest/servicess/services.jpg';
...
const Services = () => {
    ...
    const handleReadMoreClick = (event, path) => {
        event.stopPropagation(); // Prevents the card's onClick event from firing
        navigate(path); // Navigate to the same service page
      };
    ...
    return (
        <Box>
            ...
            <Box
                sx={{
                    height: { xs: '25vh', sm: '35vh', md: '30vh' },
                            ...
                            {ServiceData.map((service, index) => (
                                <Grid size={{ xs: 12, sm: 6, md: 4 }} key={index}>
                                    ...
                                    >
                                        ...
                                        <CardActions>
                                        <Button onClick={(event) => handleReadMoreClick(event, service.path)}>
          Read More
        </Button>
                                        </CardActions>
                                    </Card>
                        ...
                        <Card sx={{
                            ...
                            <CardContent sx={{ flexGrow: 1 }}>
                                <Typography variant="h5"
                                    fontWeight="bold" gutterBottom textAlign={'center'}>
                                    How can we help you?
                                </Typography>
                        ...
                        <Card sx={{
                            ...
                            <CardContent sx={{ flexGrow: 1 }}>
                                <Typography variant="h5" fontWeight="bold" gutterBottom
                                    backgroundColor='#002b5b' borderRadius={2}
                                    color='white' textAlign={'center'}>
                                    Company Presentation
                                </Typography>
                                <Typography variant="body1" paragraph textAlign={'center'}>
                                    SHSPL really helped us achieve our financial goals.
                                    The slick presentation along with fantastic readability
                                    ensures that our financial standing is stable.
                                </Typography>
                                <Box sx={{ textAlign: 'center' }}>
                                    <Typography
                                        // variant="contained"
